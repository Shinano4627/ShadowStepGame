...
// UIオブジェクトの追加・設定
// ===================================================================
void UISystemComponent::SetUIObject(std::vector<std::unique_ptr<GameObject>>& objectList)
{
...
// ボタン整列処理
// ===================================================================
void UISystemComponent::MakeUIButtons(std::vector<std::unique_ptr<GameObject>>& objectList)
{
    // UIAreaButtonsの範囲を取得
...
void UISystemComponent::MakeUITimeLine(std::vector<std::unique_ptr<GameObject>>& objectList)
{
...
void UISystemComponent::MakeUIStatus(std::vector<std::unique_ptr<GameObject>>& objectList)
{
    // UIAreaStatusを名前で取得
...
void UISystemComponent::MakeUISunRoute(std::vector<std::unique_ptr<GameObject>>& objectList)
{
    // UIAreaStatusを名前で取得
